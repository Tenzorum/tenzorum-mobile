...
export default class WalletMain extends Component<Props> {
  static navigationOptions = ({ navigation }) => {
    ...
    return {
      tabBarIcon: ({tintColor}) => <Text style={{color: 'white'}}>Accounts</Text>,
      tabBarVisible: false,
      headerVisible: false,
      headerStyle:
        {
      ...
      <View style={{flex: 1}}>
        ...
        >
          <View style={styles.container}>
            ...
            <Text style={text.greyMedium}>WAH GWAN BREDERIN</Text>
            {/*<QRCode*/}
              {/*balance={balance}*/}
            ...
            <View style={styles.bottomNav}>
              ...
              <View style={styles.buttonContainer}>
                ...
                <View style={{flex: 1, alignItems: 'flex-end'}}>
                  <TouchableOpacity onPress={() => this.setState({ visibleModal: 1 })}>Hello</TouchableOpacity>
